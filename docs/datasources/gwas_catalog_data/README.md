...
The heritability estimates are generated by running LDSC regression on the harmonised summary statistics. The results are stored in `gs://gwas_catalog_sumstats_susie/heritability_estimates/` directory. As of 26-05 dag for heritability estimation is under development.
