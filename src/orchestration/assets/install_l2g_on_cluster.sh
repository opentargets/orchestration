...
function main() {
    ...
    # Install the L2G scope (ML stack) from gentropy as defined in PR #1233.
    run_with_retry uv pip install --no-break-system-packages --system "gentropy[l2g] @ git+${REPO_URI}.git@${GENTROPY_REF}"
}
