#!/usr/bin/env bash
# =============================================================================
# Setup test environment for the FinnGen three-way (FinnGen × UKBB × MVP)
# meta-analysis DAG (finngen_ukb_mvp_meta).
#
...
#
# Source: gs://finngen-public-data-r12/meta_analysis/mvp_ukbb/
# Target: gs://ot_orchestration/test/finngen_meta/meta_analysis/mvp_ukbb/
#
# Usage:
#   bash tests/integration_env_setup/setup_test_env_three_way.sh
#   bash tests/integration_env_setup/setup_test_env_three_way.sh --dry-run
# =============================================================================
set -euo pipefail
...
# Config
# ---------------------------------------------------------------------------
SRC_BASE="gs://finngen-public-data-r12/meta_analysis/mvp_ukbb"
DST_BASE="gs://ot_orchestration/test/finngen_meta/meta_analysis/mvp_ukbb"

MANIFEST_FILE="FinnGen_R12_MVP_UKBB_manifest.tsv"
...
for PHENOTYPE in "${PHENOTYPES[@]}"; do
  SRC_FILE="${SRC_BASE}/summary_stats/${PHENOTYPE}_meta_out.tsv.gz"
  DST_FILE="${DST_BASE}/summary_stats/${PHENOTYPE}_meta_out.tsv.gz"
